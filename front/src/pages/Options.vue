...
<template>
  <div class="mx-auto flex h-full max-w-md flex-col gap-6 overflow-y-auto px-4 py-6">
    ...
    <section class="flex flex-col gap-4 rounded-xl bg-white/5 p-4">
      <h2 class="text-sm font-semibold text-white/70">Audio</h2>

      <label class="flex flex-col gap-1 text-sm">
        <span class="flex justify-between text-white/60">
    ...
    <section v-if="!isTouchDevice" class="flex flex-col gap-3 rounded-xl bg-white/5 p-4">
      <h2 class="text-sm font-semibold text-white/70">Contrôles clavier</h2>
      ...
      >
        ...
        <button
          ...
          :class="
            listeningFor === direction ? 'bg-cyan-500 text-slate-950' : 'bg-white/10 text-white/80'
          "
      ...
      <button
        type="button"
        class="self-start text-xs text-white/40 underline underline-offset-2"
    ...
    <section
      ...
      class="flex flex-col gap-3 rounded-xl bg-white/5 p-4"
    >
      <h2 class="text-sm font-semibold text-white/70">Contrôles tactiles</h2>

      <label class="flex items-center justify-between text-sm">
        <span class="text-white/60">Vibration au toucher</span>
        <input
          type="checkbox"
    ...
    <section class="flex flex-col gap-3 rounded-xl bg-white/5 p-4">
      <h2 class="text-sm font-semibold text-white/70">Accessibilité</h2>

      <label class="flex items-center justify-between text-sm">
        <span class="text-white/60">Réduire les animations</span>
        <input
          type="checkbox"
          class="h-5 w-5 accent-cyan-500"
      ...
      <label class="flex items-center justify-between text-sm">
        <span class="text-white/60">Palette daltonien</span>
        <input
          type="checkbox"
          class="h-5 w-5 accent-cyan-500"
